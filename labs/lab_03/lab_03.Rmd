...
A1:**I found 39 results.**

```{r}
pg_schools <- payments |> 
  filter(str_detect(`Vendor Name`,'PRINCE GEORGES PUBLIC') |
        str_detect(`Vendor Name`, 'PRINCE GEORGES COUNTY SCHOOL') |
        str_detect(`Vendor Name`, 'PG COUNTY PUBLIC'))
...
A2: **2020 had the largest fiscal year, maybe due to the pandemic. I noticed that 2016, 2021, and 2022 is missing.**
...
A3.**9 & 10, 6 & 7, 26 & 27 are three examples.**
...
A4: **Stem cell research funding has changed over time by decreasing a lot by 2009 and fluctuating between 7,000,000, 8,000,000, and 9,000,000 for the following years leading up to 2020**

...
media_expenses_clean |> filter(Payee_clean == "Facebook") |> group_by(committee_name) |> 
...
**A2. Some of thehe top spenders in question 1 were running for election in the U.S. House, lieutenant governor, Harford County executive, and Governor. The committees who were not candidates supported issues that surrounded healthcare reform, pay rises, progressive taxation, etc.. When looking up the ads for the top spenders I notice that all the ads say who its spondserd by and the ad is always spending highly about whomever they are talking about.**
...
**A3. Wes Moore is missing from the top list in A1. He indeed did have Facebook ads, according to Facebook's ad library. The biggest recipients of media expenses by the Democratic primary winner for governor is Ashwani Jain.**
...
```{r}
onile_ads_data<- media_expenses_clean |> filter(expense_purpose == "Onine") 
...
**A5 : We know that facebooks ads is a way a lot of candiates get their messages out, and that it can caculate who gets more money in what category. We dont know the specific effect this has on the election but a cool story idea would be to look at the relationship between who got the most money from candiates and compare that to their winning and losing success.**

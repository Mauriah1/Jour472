...
A1. **10-04 had 23 days, and no there was no days with no overdose calls.**

```{r}
call_by_date <- emergency_calls |>
  group_by(date) |>
summarise(
    count_date=n()
...
A3. **4540 SILVER SPRING RD had the most calls**.
...
A4. The biggest question I had after doing this lab was what was the demographic of people who were directly impacted by the overdose callings? I thought of this question because I thought it was interesting and could call for a good story.

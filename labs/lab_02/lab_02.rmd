...
**Q1.** How many departments have offered the courses with "Climate" in the title and at least one seat? Which department has offered the most? **A1. There were a total of 26 departments who offered the courses with "climate", the department "Atmospheric and Oceanic Sciences" offered the most.**

```{r}
umd_courses |>
  filter(str_detect(title, "Climate") & seats>=1) |> group_by (department) |>
  summarise(classes = n()) |> arrange(desc(classes))
```

**Q2.** Of the departments listed in A2, which one is the most interesting to you, and why? **A2.** Atmospheric and Oceanic Science was one of the departments that was interesting to me because this department offers the most classes and I never even heard of this course or anyone taking it, it also had a lot of seats which means it may be requested a lot.
...
**A3. The business mangement department has the most courses in the Fall 2023 term. There are 125 departments in that term that has at least one syllabus posted. The top five difference is that the school of music and English professors don't upload their syllabus posted.**
...
```{r}
#1. What is the best method for figuring out what is best to use when solving one of these questions. 
#2.Would mutating be a better tool than just summing? If you are creating a new column yes. 
```

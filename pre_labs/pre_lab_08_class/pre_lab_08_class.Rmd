...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer: It has 4 columns and 3822 rows.**
...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer: They made a new column in a new data set that they made, from the orginial information in the recent data set.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: Bar chart with each months 911 calls totals from this county, in order from least to most.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: What changed is it is changed to a vertical bar visualization with the coord_flip function.**
...
**Task** Run the following code. What do you think this does? **Answer: This shows you the file of the 911 call plot, it exports the data.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see dates that are associated with total off 911 calls that occurred on that day in Baltco.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a line chart that is showing the dates within months where the number of calls fluctuates between 5 and 20 a day for most of this period, and then jumps way up at certain points during the year.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a line chart that is hard to read because all of the months are included in the data.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a line chart that shows each month where calls fluctuates, but it has a week difference.**

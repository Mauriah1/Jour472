...
**Answer : We are storing it in a new variable so we wont loose the original data.**
...
**Answer : 231 is how many seats are in the theater and 41011 is how many seats the theater department has had in that year.**
...
**Answer: converting all the dates of the month into the smallest number of that month who has data.**
...
**Answer: We are opening up the data and then mutating. We are taking the total votes for all the campaigners and then taking the percent of Moore's votes and comparing.**
...
1.  Would mutating be a better tool than just summing?

```{=html}
<!-- -->
```
1.  When filtering with data, what is the most common filter to filter by?

2.   When looking at a department and you want to find out how many seats that department has in one room compared to how many seats is token the entire year, what is the correct explanation when explaining this?
